...
<!-- TODO: Insert image "Connecting display module and INCLINOMETER with XLR cable" -->
...
<!-- TODO: Insert image "Mounting the INCLINOMETER via the flange holes" -->
...
The INCLINOMETER units are calibrated at the factory so that the base plate must face down. If you want to use the INCLINOMETER in another orientation, it must be recalibrated. Four positions are possible (90° increments around the longitudinal axis), see [Chapter 8 Calibration](manual_8.md).
