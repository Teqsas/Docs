...
!!! warning "Warnung!"
    **Gefahr von Augenverletzungen durch Laserstrahlen!**
    ...
    Niemals in den Laser blicken oder den Laserstrahl auf reflektierende Oberflächen richten!

* Stellen Sie sicher, dass sich keine Personen im Wirkbereich des Lasers aufhalten.
* **Einschalten:** „Power-Taste" für ca. 3 Sekunden drücken.

Wurde das System ordnungsgemäß in Betrieb genommen, leuchtet der grüne Laser und der aktuelle Winkel-Messwert wird im Display angezeigt.
...
Erscheint auf dem Display der Text **„over"**, wurde der zulässige Messbereich von +/− 50° überschritten. In der praktischen Anwendung ist dieser Messumfang ausreichend.
