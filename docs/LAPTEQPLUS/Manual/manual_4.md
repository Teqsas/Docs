...
!!! abstract "Achtung!"
    **Gefahr von Geräteschäden!**
    ...
    Das gewaltsame oder falsche Anschließen des Ladekabels kann die Multifunktionsbuchse oder andere Teile des Geräts beschädigen. Schließen Sie Kabel mit der korrekten Seite an das Gerät an.
...
Der Ladezustand wird durch die Kontrollleuchte (4) angezeigt:
